...
## Sprint 1: Infrastructure & Data Modeling

**Goal:** Establish the containerized database environment and define the structural schema.

- [x] **Task 1.1:** Environment Setup. Install Docker for SQL Server 2022. Configure SQL Client for database management.
...
- [x] **Task 1.3:** Database Implementation. Write and execute T-SQL DDL scripts (connected to the Docker instance) to create the database, tables, and constraints.

## Sprint 2: Data Engineering & ETL Pipeline

**Goal:** Develop the Python mechanism to generate, validate, and load data into the containerized database.

- [x] **Task 2.1:** Python Project Setup. Initialize the virtual environment and install dependencies (`pandas`, `sqlalchemy`, `pyodbc`, ODBC driver).
- [x] **Task 2.2:** Synthetic Data Generation. Create a script to generate realistic CSV files containing valid and invalid logistics data (approx. 5,000 records).
...
## Sprint 3: Migration & Business Intelligence

**Goal:** Migrate the data to the visualization environment and build the visualization layer.

- [ ] **Task 3.1:** Database Migration (The Bridge). Execute a T-SQL `BACKUP DATABASE` command via the SQL client to generate a `.bak` file. Transfer the file to the visualization environment and restore it using a SQL client.
...
- [ ] **Task 4.2:** Documentation. Write the main `README.md` highlighting the hybrid architecture and the use of modern tooling.
